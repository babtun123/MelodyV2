...
const clefs = [
  "/static/images/treble.png",
  "/static/images/bass.png",
  "/static/images/alto.png",
];
...
const difficultyLevels = {
  easy: { clefs: ["/static/images/treble.png"], positions: 3 },
  medium: {
    clefs: ["/static/images/treble.png", "/static/images/bass.png"],
    positions: 5,
  },
  hard: {
    clefs: [
...
function generateQuestion() {
  ...
  let positionNotes;
  switch (currentClef) {
    case "/static/images/treble.png":
      positionNotes = treblePositionNotes;
      break;
    case "/static/images/bass.png":
      positionNotes = bassPositionNotes;
      break;
    case "/static/images/alto.png":
      positionNotes = altoPositionNotes;
      break;
  }

  currentNote =
    positionNotes[currentPosition][
      Math.floor(Math.random() * positionNotes[currentPosition].length)
    ];
